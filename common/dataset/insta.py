...
from common.dataset.data_utils._img_utils import normalize_2d_kp, split_into_chunks
...
class Insta(Dataset):
    def __init__(self, load_opt, seqlen, overlap=0., debug=False):
        ...
        # self.h5_file = osp.join(GLoT_DB_DIR, 'insta_train_db_vibe.h5')
        # print('insta_train_db_vibe')
